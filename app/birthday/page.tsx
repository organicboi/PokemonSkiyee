      ...
      <div className="relative z-20 min-h-screen flex flex-col">
        ...
        <div className="text-center pt-24 pb-12">
          <div className="relative inline-block">
            <h1 className="text-6xl md:text-8xl font-bold bg-gradient-to-r from-cyan-400 via-teal-300 to-cyan-500 bg-clip-text text-transparent mb-6 animate-pulse">
              Miku&apos;s Birthday Magic
            </h1>
            <div className="absolute -top-4 -right-4 text-4xl animate-bounce">🎤</div>
          </div>
          <p className="text-2xl text-cyan-200/90 mb-4 font-light">A digital symphony of love</p>
          <div className="flex items-center justify-center space-x-6 text-cyan-300/80">
            <div className="flex items-center space-x-2">
              <div className="w-2 h-2 bg-cyan-400 rounded-full animate-pulse"></div>
              <span className="text-lg">Day {currentDayIndex + 1} of 12</span>
            </div>
            <div className="w-1 h-6 bg-cyan-400/30 rounded-full"></div>
            <div className="flex items-center space-x-2">
              <div className="w-2 h-2 bg-teal-400 rounded-full animate-pulse"></div>
              <span className="text-lg">July {14 + currentDayIndex}, {currentYear}</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex justify-center mb-12">
          <div className="relative group">
            ...
            <div className="relative bg-black/30 backdrop-blur-2xl rounded-3xl p-8 border border-cyan-400/30 hover:border-cyan-400/50 transition-all duration-300">
              <div className="text-center mb-8">
                <h2 className="text-3xl font-bold text-cyan-100 mb-3">Until July 26th</h2>
                <div className="w-40 h-1 bg-gradient-to-r from-cyan-400 to-teal-400 rounded-full mx-auto animate-pulse"></div>
              </div>
              ...
              <div className="grid grid-cols-4 gap-8">
                {[
                  ...
                  <div key={index} className="text-center group">
                    <div className={`relative w-20 h-20 mx-auto mb-3 rounded-2xl bg-gradient-to-br ${item.color} flex items-center justify-center text-white font-bold text-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105`}>
                      <div className="absolute inset-0 bg-white/10 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                      <span className="relative z-10">{item.value.toString().padStart(2, '0')}</span>
                    </div>
                    <div className="text-cyan-200 text-sm font-medium mb-1">{item.label}</div>
        ...
        <div className="max-w-3xl mx-auto mb-12 px-6">
          <div className="relative group">
            ...
            <div className="relative bg-black/20 backdrop-blur-2xl rounded-3xl p-8 border border-cyan-400/20 hover:border-cyan-400/40 transition-all duration-300">
              <div className="flex justify-between items-center mb-6">
                <div className="flex items-center space-x-3">
                  <div className="text-2xl animate-bounce">🎵</div>
                  <span className="text-cyan-200 text-xl font-medium">Journey Progress</span>
                </div>
                <div className="flex items-center space-x-2">
                  <span className="text-cyan-400 font-bold text-2xl">{Math.round(getProgressPercentage())}%</span>
                  <div className="text-xl">✨</div>
                </div>
              </div>
              <div className="relative w-full bg-black/30 rounded-full h-4 overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-cyan-400/20 to-teal-400/20 animate-pulse"></div>
                <div 
                  className="relative bg-gradient-to-r from-cyan-400 via-teal-400 to-cyan-500 h-4 rounded-full transition-all duration-1000 ease-out shadow-lg"
        ...
        {getTodaysSurprise() && (
          <div className="max-w-2xl mx-auto mb-12 px-6">
            <div className="relative group">
              ...
              <div className="relative bg-black/30 backdrop-blur-2xl rounded-3xl p-8 border border-cyan-400/40 hover:border-cyan-400/60 transition-all duration-300 overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-cyan-400/5 to-teal-400/5 animate-pulse"></div>
                <div className="relative z-10 text-center">
                  <div className="text-6xl mb-4 animate-bounce">{getTodaysSurprise().emoji}</div>
                  <h3 className="text-3xl font-bold text-cyan-100 mb-3">Today&apos;s Special</h3>
                  <p className="text-cyan-300 text-xl mb-6 font-medium">{getTodaysSurprise().title}</p>
                  <button
                    onClick={() => handleSurpriseClick(getTodaysSurprise())}
                    className="relative group bg-gradient-to-r from-cyan-500 to-teal-500 text-white px-10 py-4 rounded-2xl font-medium hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl text-lg"
                  >
                    <div className="absolute inset-0 bg-white/10 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
        ...
        <div className="max-w-6xl mx-auto px-6 mb-12">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-cyan-100 mb-4">12 Days of Miku Magic</h2>
            <div className="w-32 h-1 bg-gradient-to-r from-cyan-400 to-teal-400 rounded-full mx-auto"></div>
          </div>
              ...
              return (
                ...
                >
                  <div className={`relative rounded-2xl p-6 backdrop-blur-xl border transition-all duration-500 ${
                    ...
                    <div className="relative z-10 text-center">
                      <div className={`text-4xl mb-3 ${isToday ? 'animate-bounce' : ''}`}>
                        {isUnlocked ? surprise.emoji : '🔒'}
                      </div>
                      <div className="text-sm font-bold text-cyan-100 mb-2">Day {index + 1}</div>
                    ...
                    {/* Status indicators */}
                    {isToday && (
                      <div className="absolute -top-3 -right-3 w-8 h-8 bg-gradient-to-r from-cyan-400 to-teal-400 rounded-full flex items-center justify-center animate-bounce shadow-lg">
                        <span className="text-sm">🎁</span>
                      </div>
                    )}
                    
                    {isPast && !isToday && (
                      <div className="absolute -top-3 -right-3 w-8 h-8 bg-gradient-to-r from-teal-400 to-cyan-400 rounded-full flex items-center justify-center shadow-lg">
        ...
        {timeLeft.totalSeconds <= 0 && (
          <div className="max-w-3xl mx-auto px-6 mb-12">
            <div className="relative group">
              ...
              <div className="relative bg-black/30 backdrop-blur-2xl rounded-3xl p-12 border border-cyan-400/50 text-center">
                <div className="text-8xl mb-6 animate-bounce">🎉</div>
                <h2 className="text-5xl font-bold text-cyan-100 mb-6">HAPPY BIRTHDAY!</h2>
      ...
      {showSurpriseModal && selectedSurprise && (
        <div className="fixed inset-0 bg-black/90 backdrop-blur-md flex items-center justify-center z-50 p-4">
          <div className="relative group max-w-2xl w-full">
            ...
            <div className="relative bg-black/40 backdrop-blur-2xl rounded-3xl p-10 border border-cyan-400/40 overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-r from-cyan-400/5 to-teal-400/5 animate-pulse"></div>
              
              <div className="relative z-10 text-center">
                <div className="text-8xl mb-8 animate-bounce">{selectedSurprise.emoji}</div>
                
                <div className="mb-8">
                  <h3 className="text-3xl font-bold text-cyan-100 mb-3">Day {selectedSurprise.id}</h3>
                  <h4 className="text-2xl text-cyan-300 mb-6 font-medium">{selectedSurprise.title}</h4>
                </div>
                
                <div className="bg-black/40 rounded-3xl p-8 mb-8 border border-cyan-400/20">
                ...
                <button
                  ...
                  className="group bg-gradient-to-r from-cyan-500 to-teal-500 text-white px-10 py-4 rounded-2xl font-medium hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl text-lg"
                >
                  <div className="absolute inset-0 bg-white/10 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                  <span className="relative z-10 flex items-center space-x-2">
